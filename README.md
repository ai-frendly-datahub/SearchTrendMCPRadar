# SearchTrendMCPRadar - 검색/트렌드 MCP 레이더

**🌐 Live Report**: https://ai-frendly-datahub.github.io/SearchTrendMCPRadar/


Search & Trends 섹션의 한국 MCP 서버 목록을 수집하고 리스크/활성도를 추적하는 독립 Radar입니다.
...
2. 실행:
   ```bash
   python main.py --category search_trend_mcp --recent-days 7
   # 리포트: reports/search_trend_mcp_report.html
   ```
...
Radar-Template/
  ...
  config/
    ...
    categories/
      search_trend_mcp.yaml  # 소스 + 엔티티 정의
  radar/
    collector.py          # 데이터 수집
    analyzer.py           # 엔티티 태깅
...
- GitHub Pages visualization: `reports/index.html` (valid HTML); https://ai-frendly-datahub.github.io/SearchTrendMCPRadar/.
